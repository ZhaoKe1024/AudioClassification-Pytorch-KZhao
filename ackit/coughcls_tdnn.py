...
class TrainerTDNN(object):
    ...
    def __setup_dataloader(self):
        ...
        self.train_loader = DataLoader(train_dataset, batch_size=self.configs["fit"]["batch_size"], shuffle=True,
                                       collate_fn=collate_fn)
        valid_dataset = CoughVID_Dataset(path_list=vap, label_list=val)
        self.valid_loader = DataLoader(valid_dataset, batch_size=self.configs["fit"]["batch_size"], shuffle=True,
                                       collate_fn=collate_fn)
